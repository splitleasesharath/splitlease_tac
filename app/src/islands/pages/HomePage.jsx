  ...
  const schedules = [
    {
      ...
      days: '1,2,3,4,5', // Monday-Friday (0-based: 0=Sunday, 6=Saturday)
    },
    {
      type: 'weekend',
      ...
      days: '5,6,0,1', // Fri-Mon (0-based: Friday, Saturday, Sunday, Monday)
    },
    {
      type: 'monthly',
      ...
      days: '0,1,2,3,4,5,6', // All days (0-based: Sunday-Saturday)
    },
  ];
...
function ListingsPreview({ selectedDays }) {
  ...
  const handleListingClick = (propertyId) => {
    // Use 0-based indexing for URL parameters (0=Sunday, 6=Saturday)
  ...
  const handleShowMore = () => {
    // Use 0-based indexing for URL parameters, default to Monday-Friday
    const daysParam = selectedDays.length > 0 ? selectedDays.join(',') : '1,2,3,4,5';
